      ...
      <div className="mx-auto w-full max-w-3xl space-y-6">
        ...
        <section className="rounded-3xl border border-white/12 bg-surface/85 p-6 shadow-xl shadow-black/40 sm:p-8">
          ...
          <p className="mt-3 text-sm leading-6 text-muted">
            Use the same email address you entered at Paystack. Once you are signed
            in, open My Reports and recover paid guest reports into your account.
          </p>

          <AuthMagicLinkForm className="mt-6" redirectTo="/my-reports" />
        </section>
      </div>
    </main>
  );
